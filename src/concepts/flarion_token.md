...
FLR is issued in **limited supply**. Holding a Flarion Token designates the user as an **Elysian Account**, granting privileges such as access to Elysian section of ecosystem, the Pledge Contract system, the Verifiable Document Service, and the Pulse execution suite.
